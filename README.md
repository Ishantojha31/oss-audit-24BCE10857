...
**Student:** Ishant Kumar Ojha | **Registration:** 24BCE10857
**Slot:** E11 | **Date:** 31/03/2026
...
│
└── report/
    └── OSS_Audit_24BCE10857.pdf       <-- Final project report 
```
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/Ishantojha31/oss-audit-24BCE10857.git
   cd oss-audit-24BCE10857/scripts
   ```
